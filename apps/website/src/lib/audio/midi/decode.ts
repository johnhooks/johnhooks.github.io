import type { MidiPortInterface } from "./types";
import { CCModeValues, StatusByte, type Channel } from "./types";
import { CHANNEL_MASK, DATA_MASK } from "./constants";

export abstract class Decoder implements MidiPortInterface<void> {
  /**
